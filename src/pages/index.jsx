...
export default function Home() {
  /* Links */
  const headerLinks = [
    { name: "Banco de dados", href: "#section-dataBases", samePage: true },
    { name: "SGBDs", href: "#section-SGBDs", samePage: true },
    { name: "Teorema CAP", href: "#section-teoremaCAP", samePage: true },
    { name: "MongoDB", href: "#section-mongoDB", samePage: true },
    { name: "Índice em BD", href: "/indexes-db", samePage: false },
  ];
  const footerLinks = [
    {
      name: "ibm.com",
  ...
  return (
    <>
      ...
      <Content>
        <a name="section-dataBases"></a>
        <Section>
          <SectionContainer>
            <Title size={2}>O que é?</Title>

            <p>
              Trata-se de uma tecnologia que permite o armazenamento e a gestão
              organizada de dados estruturados ou não estruturados, a fim de
              fazer com que eles fiquem mais gerenciáveis, acessíveis e sempre
              atualizados. É possível dizer que um banco de dados é o local onde
              as informações ficam armazenadas.
            </p>

            <p>
              Os bancos de dados são estruturas lógicas usadas para organizar e
              armazenar dados para processamento, recuperação ou avaliações
              futuras.
            </p>
          </SectionContainer>
          ...
          <SectionContainer>
            ...
            <p>
              O banco de dados se torna uma ferramenta fundamental para agilizar
              e colher as informações necessárias para as negociações. Armazenar
              e fazer a gestão dessas informações e dados são de fundamental
            ...
            <div className="m-container invert-colors">
              ...
              <ul className="list">
                ...
                <li className="item">
                  Possibilita traçar o perfil do público e a manter relação com
                  ele;
                </li>
        ...
        <Section>
          <SectionContainer>
            ...
            <p>
              ...
              é um conjunto de softwares, utilizado para o gerenciamento de uma
              base de dados. Responsáveis por controlar, acessar, organizar e
              proteger as informações de uma aplicação, tendo como
            </p>
          </SectionContainer>
          ...
          <SectionContainer>
            ...
            <p>
              Tudo que fazemos em um banco de dados passa pelo SGBD! Sendo ele
              responsável por salvar os dados no HD, manter em memória os dados
              mais acessados, ligar dados e metadados, disponibilizar uma
              interface para que programas e usuários externos acessem o banco
              de dados, encriptar dados, controlar o acesso a informações,
          ...
          <SectionContainer>
            ...
            <div className="m-container invert-colors">
              ...
              <ul className="list">
                ...
                <li className="item">
                  ...
                  drasticamente a redundância, como regra geral a informação no
                  SGBD só aparece uma vez, e isso reduz a redundância e
                  sucessivamente diminui o custo de armazenamento de informações
                  em discos rígidos ou outros dispositivos de armazenamento;
                </li>
            ...
            <p>
              Até alguns anos atrás utilizar um SGBD para gerenciar o seu banco
              de dados era algo opcional, hoje é algo primordial, devido às
              aplicações estarem cada vez mais utilizando dados, é necessário
              ter um controle maior e mais eficiente e com um SGBD você vai
              conseguir isso, com mais facilidade e além de muitas outras
              vantagens.
            </p>
          </SectionContainer>
        </Section>

        <a name="section-teoremaCAP"></a>
        <Section>
          <SectionContainer>
            ...
            <p>
              O Teorema CAP afirma que não é possível que um sistema distribuído
              consiga aplicar às três características:
            </p>
            ...
            <div className="m-container invert-colors">
              <ul className="list">
                ...
                <li className="item">Particionamento (Partition tolerance).</li>
              </ul>
            </div>
          </SectionContainer>
          ...
          <SectionContainer>
            ...
            <div className="s-container">
              ...
              <p>
                ...
                todos devem ver o mesmo. Quando algo é registrado em um nó, ele
                deve ser replicado aos outros nós.
              </p>
            </div>
            ...
            <div className="s-container">
              ...
              <p>
                ...
                esteja com a sua versão mais recente, mas se deve ter a garantia
                da resposta sem falha.
              </p>
            </div>

            <div className="s-container">
              <Title size={1.2}>
                Particionamento <br /> — Mesmo sem um nó, continua funcionando?
                —
              </Title>
              <p>
                Caso os nós não consigam se comunicar, o sistema deve continuar
                funcionando. Criando grupos de nós isolados que mantenham o
        ...
        <Section>
          <SectionContainer>
            ...
            <div className="m-container invert-colors">
              ...
              <p>
                Esse sistema entrega consistência e disponibilidade, mas no caso
                de particionamento não entrega tolerância a falhas.
              </p>
            ...
            <div className="m-container invert-colors">
              ...
              <p>
                Em caso de particionamento de dois nós, o sistema desativa o nó
                inconsistente até ele estar novamente consistente com os outros
                nós, assim o funcionamento consistente sempre se mantém.
              </p>
            ...
            <div className="m-container invert-colors">
              ...
              <p>
                Os nós sempre ficam disponíveis mesmo em caso de particionamento
                e podem retornar uma versão antiga dos dados, somente após a
                partição ser resolvida que os dados inconsistentes são
                sincronizados.
              </p>
